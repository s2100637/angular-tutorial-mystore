export const products = [
  {
    ...
    price: 795,
    short_desription:
      'Phone X features an all-screen design with a 5.8-inch Super Retina HD display with HDR and True Tone... more ',
